...
<!-- Місце для релізного скріншота: docs/screenshots/uk/storage-and-logs.png
Зніміть повну вкладку «Сховище та логи» з адресами тек, кнопками Logcat і
«Поділитись конф-єю», кнопками надсилання/сортування та хоча б одним рядком дня.
Не залишайте відкриту модалку, активну операцію або приватні дані маршруту.
Рекомендована розмітка:
