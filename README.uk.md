...
Режим екрану та геометрія доступні у `Налаштування → Розміри вікна на приборці`.
...
| Орієнтація та напрямок | Вертикальна, вниз | Вертикальна: вгору/вниз; горизонтальна: вліво/вправо |
...
| Колір | Синій `#2F86F6` | Вибір кольору |
| Розмір і колір рамки | 2 dp, чорний `#000000` | 0–16 dp; 0 прибирає рамку |
...
Категорія `Перенесення на приборку` у налаштуваннях зарезервована для майбутньої функції; для переміщення застосунків використовуйте наявні кнопки вкладки `Застосунки`.
