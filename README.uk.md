...
Заокруглена кнопка `?` біля базових налаштувань, ЕТА, обмежень швидкості та Waze відкриває схематичний передпоказ. Його локальний перемикач змінює лише картинку, а не збережене налаштування чи HUD. Приклади відповідають українській/англійській мові застосунку. Експериментальні поля ЕТА/Waze — заглушки для наступного патчу: вибір зберігається, але поточний вивід залишається в наявних полях вулиці/маневру. Наведені нижче скріншоти зроблені до цього перенесення UI.
...
| `Поле виводу ЕТА` | Вулиці | Вулиці або Експериментальне; експериментальний вибір зберігається для наступного патчу й поки не змінює звичайний вивід |
...
| `Поле виводу попередження Waze` | Маневру | Маневру або Експериментальне; експериментальний вибір зберігається для наступного патчу й поки не змінює звичайний вивід |
