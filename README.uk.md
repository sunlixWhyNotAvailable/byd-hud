...
Експорт зчитує доступну діагностику без перемикання режимів автомобіля чи відновлення дозволів. Уже авторизоване ADB дає додаткові зчитування; без нього базовий архів залишається доступним. Непідтримувані та невдалі зчитування позначаються окремо, а не як вимкнені функції. У підтвердженні можна вибрати стандартне меню надсилання Android або надсилання розробнику через Sentry. Облікові дані виключаються, мережеві адреси маскуються.
