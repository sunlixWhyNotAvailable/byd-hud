...
`Почати Logcat` / `Зупинити Logcat`, `Поділитись` і сортування розташовані поруч зі шляхами тек. Дні вибираються в окремій секції `Логи`; внизу неї — `Поділитись конфігурацією` та `Видалити вибране`. Надсилання конфігурації не потребує вибраних днів.
...
`Поділитись` пропонує два явні способи:
...
3. Натисніть `Поділитись` і виберіть месенджер або `Надіслати розробнику`.
