...
Вибраний застосунок уже повинен мати запущений task, а перенесення на приборку потребує авторизованого ADB. Якщо застосунок на основному екрані, одне натискання переносить його на приборку з вибраним профілем; якщо він уже на приборці, та сама кнопка повертає його на основний екран. Якщо поточний task неможливо підтвердити, BYD HUD не змінює ані застосунок, ані штатну дію кнопки. Повторні натискання під час перенесення ігноруються й не додаються в чергу. Після завершення нове натискання враховує фактичний екран застосунку, зокрема після перенесення із вкладки «Застосунки». Невдале перенесення супроводжується повідомленням.

Навчання кнопки використовує ввімкнену службу спеціальних можливостей. Можна призначити будь-яку кнопку керма, подію якої отримує Android; поки task вибраного застосунку активний, BYD HUD перехоплює цю кнопку замість її штатної дії. Скиньте кнопку або вибраний застосунок, щоб вимкнути це призначення. Доступність конкретних кнопок залежить від обладнання та прошивки автомобіля, тому деякі з них можуть не визначатися.
