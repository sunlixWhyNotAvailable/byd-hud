...
Повноекранний режим використовує штатне перемикання й залишається вибраним після дії «На основний екран», показуючи чорну область проєкції. Частковий режим використовує AutoContainer і звільняє це підключення при поверненні застосунку або виборі іншого режиму віджетом. Повернення автоматично не вмикає TBT. Наявне налаштування автоматичного TBT діє на старті навігації, зокрема з повноекранного режиму; кнопки TBT та IPC OFF віджету явно змінюють режим.
