...
| Ручне тестування | Надсилання діагностичних навігаційних полів через підтримувані виходи лобового HUD і картки панелі приладів |
...
| Прямий вивід і патчення Google Maps | `app.revanced.android.apps.maps` | Google Maps ReVanced `25.16.03.747108139` або `26.30.09.950492155`; версія 26.30 залишається збіркою для перевірки на авто |
...
| `Права: OK` | Потрібні налаштування та служби захоплення готові |
| `Права: немає` | Потрібно відновити одне або кілька налаштувань чи служб захоплення |
...
2. Натисніть `Перевірити`, щоб переконатися в цілісності пакета та відповідності його файлів і структури підтримуваній версії.
...
Вкладка `Ручний` є діагностичним інструментом і не потребує активного маршруту в Google Maps або Waze. Увімкнення ручного режиму публікує вибрані тестові значення тексту, відстані, смуг, PNG і штатної стрілки через ті самі підтримувані автомобільні виходи, що й активна навігація. Автомобільні дисплеї не дублюють кожне поле: TBT-картка панелі приладів використовує штатний маневр і текст, а не копію зображення смуг або PNG із HUD. Швидкі зміни об'єднуються, щоб показувався лише останній стан. Вимкнення ручного режиму очищає його дані та повертає керування активній навігації. Ручний режим не слід використовувати як джерело навігації.
