...
`Штатний` наразі є заглушкою у вихідному коді: режим можна вибрати та зберегти, а передачу в автомобіль буде реалізовано окремо. Він не надсилає знак обмеження й не змінює наявний знак ADAS. Підказка ілюструє 115 у штатному полі (режим «Вимкнено» — 40); вибір у підказці не змінює налаштування та нічого не передає на HUD. Накладання, його тривалість і композитні налаштування недоступні у штатному режимі, але їхні значення зберігаються. Ці зміни коду ще не зібрано в APK.
