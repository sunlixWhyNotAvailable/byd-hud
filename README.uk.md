...
Навігатор уже повинен бути запущений. BYD HUD запитує вибраний повний або компактний режим, переміщує вікно навігатора та перевіряє, що воно потрапило на панель приладів. Під час активного маршруту з custom surface Waze маршрутний екран переміщується разом із Waze, тому екран налаштувань BYD HUD не переноситься помилково. На перевіреній прошивці BYD HUD не може надійно зчитати фактичний режим панелі приладів, тому перемикач показує запитаний режим; після зміни режиму автомобілем його може знадобитися застосувати повторно. Керування панеллю приладів потребує авторизованого ADB.
...
Після успішного відкриття системного меню Android BYD HUD знімає вибір днів, використаних для цього архіву. Помилка створення архіву або відкриття меню зберігає вибір; дія `Надіслати розробнику` його не знімає.
