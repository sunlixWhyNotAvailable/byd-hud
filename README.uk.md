...
Відкрийте `Налаштування → Перенесення на приборку`, щоб призначити кнопку керма, вибрати встановлений користувацький застосунок і профіль `Обраний профіль`, `Частковий` або `Повний`. Список використовує назви та іконки встановлених застосунків Android і не запускає вибраний застосунок.
...
Навчання та перехоплення кнопки потребують увімкненої служби спеціальних можливостей. BYD HUD завжди поглинає події призначеної кнопки, які отримує служба, навіть якщо вибраний застосунок закритий, жодного застосунку не вибрано, перенесення вже триває або перевірка завершується помилкою. Штатна дія кнопки не виконується. Щоб повернути її, скиньте призначення кнопки; скидання лише вибраного застосунку припиняє перенесення, але залишає кнопку призначеною. Доступність конкретних кнопок залежить від обладнання та прошивки автомобіля, тому деякі з них можуть не визначатися.

<p align="center"><img src="docs/screenshots/uk/settings-dashboard-transfer.png" alt="Налаштування перенесення на приборку з кнопкою керма, застосунком та профілем вікна" width="100%"></p>
