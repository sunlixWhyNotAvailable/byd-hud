...
Після повернення застосунку BYD HUD зберігає проєкцію для повторного використання й закриває її область чорним. Наступне перенесення використовує її знову, якщо вона придатна, та прибирає покриття після підтвердження видимого застосунку на потрібному дисплеї. До перемальовування застосунку можливий короткий показ попереднього кадру. Повне вимкнення BYD HUD звільняє збережену проєкцію.
