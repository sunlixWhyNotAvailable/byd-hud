...
internal object HudHelpCatalog {
    val topics: List<HudHelpTopic> = listOf(
        ...
        topic(HudHelpTopicId.SpeedLimitNativeClearMode,
            ...
            frame("В кінці навігації", "At navigation end", "В конце навигации",
                "Одна спроба прибрати штатний знак після завершення навігації",
                "Make one attempt to clear the native sign when navigation ends",
                "Одна попытка убрать штатный знак после завершения навигации",
